...
class Current extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tradeReceive, otherReceive, amountSub, amountAssc, fixedDeposit, cash_bank', 'required'),
			array('tradeReceive, otherReceive, amountSub, amountAssc, fixedDeposit, cash_bank', 'numerical'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, tradeReceive, otherReceive, amountSub, amountAssc, fixedDeposit, cash_bank', 'safe', 'on'=>'search'),
		);
	}
